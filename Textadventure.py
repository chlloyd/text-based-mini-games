...
def survive(a):
    ...
    if firstTurn == True and name != '/reset':
        ...
        if name=="1":
        ...
        elif name=="131":return "You wait for some time and are summoned to go out for lunch , you try to notice the door codes but are unable to see them enter anything, maybe a different activity will free you. \nTry going back to the start and chosing a different option"

        elif name=="132":return "As you attempt to sneak into the line for the jabberwocky early , Tom and his all seeing eyes notices your unfairness and proceeds to punish you by forcing you to cook everyones meals \nGame over!!!!!!\nTry chosing a different path or enter '/reset' to exit the game"

        elif name=="133":return "You return to leave the building and as you reach the doors, you are stopped by tom and his amazing cardio for dangerous running and are thrown into the time out corner \nGame over!!!!!!\nTry chosing a different path or enter '/reset' to exit the game"
            ...
            return"Suddenely you feel sleepy and your eyes slowly close, suddenly the air is cold and you slowly hearing from the opposite , Hey,you , You're finally awake as you see Tom waking you up as you have slept through all of hackthemidslands \nGame over!!!!!!\nTry chosing a different path or enter '/reset' to exit the game"

        elif name == "32":
            return"You feel tetris is a great game to copy , after 4 hours of perfect planning and coding , you find Tom in the reflection of your screen , he is not happy with plagarism , He curses you to forever get the wrong tetris piece \nGame over!!!!!!\nTry chosing a different path or enter '/reset' to exit the game"

        elif name == "33":
            return"You feel Mario is well known but feel if you make them electricians instead it will be fine.after 4 hours of perfect planning and coding , you find Tom in the reflection of your screen, he is not happy with plagarism, he curses you to forver get a static shock everytime you type \nGame over!!!!!!\nTry chosing a different path or enter '/reset' to exit the game"

        elif name=="34":
            return"Pokemon is a simple process to copy but not wishing to risk copyright issues, you decide to name the game digimon. Who would name something that bad? After 4 hours of perfect planning and coding, you find Tom in the reflection of your screen. he is happy with the presence of pokemon and leaves you be. but you did not learn anything about the door codes \nTry chosing a different path or enter '/reset' to exit the game"
